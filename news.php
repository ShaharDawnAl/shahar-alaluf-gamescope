...
?>
    ...
    <body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-right" id="navbar-middle">
                        ...
                        <li>
                            <a href="news.php" id="nav-active">News</a>
                        </li>
                        <li>
        ...
        ?>
            ...
            if (count((array)$newsbydate)<3)
            {
                $newsbydate[0] = new News();
                $newsbydate[0]->setNewsId(0);
                $newsbydate[1] = new News();
                $newsbydate[1]->setNewsId(0);
                $newsbydate[2] = new News();
                $newsbydate[2]->setNewsId(0);
            }
        ...
        ?>
                    ...
                    <header id="myCarousel" class="carousel slide">
                        ...
                        ?>
                            ...
                            <?php
				        $newsid = $newsbydate[1]->getNewsId();
				        $n1 = $db->getNewsByNewsId($newsid);
                    ?>
                                <div class="item">
                                    <div class="fill" style="background-image:url('<?php echo $n1->getNewsCarPic(); ?>');"></div>
                                    <div class="carousel-caption">
                                        <h2>
                                            <?php
                                        // echo the title with checks
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <nav class="navbar navbar-default" role="navigation" id="home-search">
                                ...
                                <span class="icon-bar"></span>
                                    ...
                                    <div class="navbar-brand" style="color: white; font-size: 30px;">News</div>
                                </div>
                                <!-- Collect the nav links, forms, and other content for toggling -->
                        ...
                        <div class="row">
                            <div class="col-md-12" style="">
                                <div class="demo demo4_top">
                                    ...
                                    $statement = "news order by news_date DESC";
                                    echo pagination("news", $statement,$limit,$page);
                                ?>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="more-news">
                            <?php 
                        $db = new dbClass();
                        $newsArray=$db->getNewsOrdered($startpoint, $limit);
                                ...
                                <div class="row" style="padding:1%; word-wrap: break-word;">
                                    <div class="col-md-3">
                                        <a href="newscontent.php?newspage='.$newsArray[$i]->getNewsId().'">
                                            <img class="news-images" src="'.$newsArray[$i]->getNewsBoxPic().'" alt="">
                                        </a>
                                    </div>
