...
?>
    ...
    <body>
        ...
        ?>
                    ...
                    <div class="row" id="details">
                        <div class="col-md-12">
                            <div class="adminman">
                                <div class="row" id="message-us">
                                    <div class="title-contact-form">
                                        <p>Create Codes Form</p>
                                    </div>
                                    <div class="col-md-2">
                                    </div>
                                    <div class="col-md-8">
                                        <div class="well well-sm">
                                            <form class="form-horizontal" action="addcodes.php" method="post" enctype="multipart/form-data">
                                                <fieldset>
                                                    <!-- Create Codes Form -->
                                                    <!-- Text input-->
                                                    <div class="control-group">
                                                        <label class="control-label" for="codesuser">Code Uploaded By:</label>
                                                        <div class="controls">
                                                            <input id="codesuser" name="codesuser" value="<?php echo $_SESSION['username']; ?>" class="form-control input-large" type="text" placeholder="" required="required" readonly>
                                                        </div>
                                                    </div>
                                                    <div class="control-group">
                                                        <label class="control-label" for="codesTitle">Code Title:</label>
                                                        <div class="controls">
                                                            <input id="codesTitle" name="codesTitle" class="form-control input-large" type="text" placeholder="" pattern=".{5,}" required="required">
                                                        </div>
                                                        <em>Minimum 5 letters</em>
                                                    </div>
                                                    <div class="control-group">
                                                        <label class="control-label" for="codesDescription">Codes Description:</label>
                                                        <div class="controls">
                                                            <textarea name="codesDescription" id="message" class="form-control" rows="9" cols="25" minlength="30" required="required" placeholder=""></textarea>
                                                        </div>
                                                    ...
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls">
                                                            <input id="codesVideo" name="codesVideo" class="form-control input-large" type="text" placeholder="">
                                                            <em>Not required, will be presented on front content page</em>
                                                        </div>
                                                    </div>
                                                    <br>
                                                    <div class="control-group">
                                                        <input type="checkbox" name="codesActive" value="active" checked> Activate (Will be showen on the list)<br>
                                                    </div>
                                                    <div class="full-width" id="upload">
                                                        <input type="file" name="codes_carousel_picture" id="base-input" class="form-control form-input form-style-base" accept="image/*" required="required">
                                                    ...
                                                    <div class="full-width" id="upload">
                                                        <input type="file" name="codes_box_picture" id="base-input1" class="form-control form-input form-style-base" accept="image/*" required="required">
                                                    ...
                                                    <div class="col-sm-12" style="display:inline-block;">
                                                        <div class="control-group">
                                                            <label class="control-label" for="confirmsignup"></label>
                                                            <div class="controls">
                                                                <button name="confirmcodescreate" class="btn btn-success" type="submit">Create Codes</button>
                ...
                <!-- Javascript code for handling fakepath text -->
                <script>
