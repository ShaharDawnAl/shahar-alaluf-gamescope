...
<body>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                ...
                <ul class="nav navbar-nav navbar-right" id="navbar-middle">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li>
                                <a href="walkthroughs.php" class="cheats-active">Walkthroughs</a>
                            </li>
                        </ul>
                    </li>
                    <li>
        ...
        if (isset($_SESSION['username']))
        {
            ...
            <div class="col-md-12">
                <div class="adminman">
                    <div class="row" id="message-us">
                        <div class="title-contact-form"><p>News Contents</p></div>
						<div class="col-md-12">
							<div class="well well-sm table-responsive" style="overflow:auto; height: 280px;">
								<?php
									$db = new dbClass();
    ...
    <?php
            // Get the walkthroughs for front page ordered by date!
            $db = new dbClass();
            $walkthroughsbydate = $db->getWalkthroughsFrontDateOrdered();
            if (count((array)$walkthroughsbydate)<3)
            {
                $walkthroughsbydate[0] = new Walkthroughs();
                $walkthroughsbydate[0]->setWalkthroughsId(0);
                $walkthroughsbydate[1] = new Walkthroughs();
                $walkthroughsbydate[1]->setWalkthroughsId(0);
                $walkthroughsbydate[2] = new Walkthroughs();
                $walkthroughsbydate[2]->setWalkthroughsId(0);
            }
            $countnews = count((array)$walkthroughsbydate);
        ?>
            <!-- Header Carousel -->
            <header id="myCarousel" class="carousel slide">
                ...
                <div class="carousel-inner" style="border-top:2px solid white; border-bottom:1px solid white">
                    <div class="item active">
                        <?php
                            $walkthroughsid = $walkthroughsbydate[0]->getWalkthroughsId();
                            $w1 = $db->getWalkthroughsByWalkthroughsId($walkthroughsid);
                        ?>
                        <div id="carouselStyle" class="fill" style="background-image:url('<?php echo $w1->getWalkthroughsCarPic(); ?>');"></div>
                        <div class="carousel-caption">
                            <h2>
                                <?php
                                    // echo the title with checks
                                    if (strlen($w1->getWalkthroughsTitle())>40)
                                        echo substr($w1->getWalkthroughsTitle(), 0, 40)."...";
                                    else
                                    {
                    ...
                    <?php
				        $walkthroughsid = $walkthroughsbydate[1]->getWalkthroughsId();
				        $w1 = $db->getWalkthroughsByWalkthroughsId($walkthroughsid);
                    ?>
                    <div class="item">
                        <div class="fill" style="background-image:url('<?php echo $w1->getWalkthroughsCarPic(); ?>');"></div>
                            <div class="carousel-caption">
                                <h2>
                                    <?php
                                        // echo the title with checks
                    ...
                    <?php
                        $walkthroughsid = $walkthroughsbydate[2]->getWalkthroughsId();
                        $w1 = $db->getWalkthroughsByWalkthroughsId($walkthroughsid);
				    ?>
                    <div class="item">
                        <div class="fill" style="background-image:url('<?php echo $w1->getWalkthroughsCarPic(); ?>');"></div>
    ...
    <div class="container">
        ...
        <div class="row">
                    <nav class="navbar navbar-default" role="navigation" id="home-search">
                        ...
                        <div class="navbar-header">
                            ...
                            <div class="navbar-brand" style="color: white; font-size: 30px;">Walkthroughs</div>
                        </div>
                        <!-- Collect the nav links, forms, and other content for toggling -->
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse">
                            <form class="navbar-form col-lg-5" id="navbar-form3" role="search" action="search.php" method="post">
        ...
        <div class="row">
                        ...
                        <div class="demo demo4_top">
                            <div class="paging-top">
                                <?php
                                    ...
                                    $statement = "walkthroughs order by walkthroughs_date DESC";
                                    echo pagination("walkthroughs", $statement,$limit,$page);
                                ?>
                            </div>
                        </div>
                    </div>
                ...
                <div class="more-news">
                    <?php 
                        $db = new dbClass();
                        $walkthroughsArray=$db->getWalkthroughsOrdered($startpoint, $limit);
                                ...
                                <div class="row" style="padding:1%; word-wrap: break-word;">
                                    <div class="col-md-3">
                                        <a href="walkthroughscontent.php?walkthroughspage='.$walkthroughsArray[$i]->getWalkthroughsId().'">
                                            <img class="news-images" src="'.$walkthroughsArray[$i]->getWalkthroughsBoxPic().'" alt="">
                                        </a>
                                    </div>
