                                ...
                                <div class="row" id="message-us">
                                    ...
                                    <div class="col-md-4">
                                        <div class="well well-sm">
                                            <div class="title-contact-form" style="text-align: center;">
                                                <p>Create Section</p>
                                            </div>

                                            <a class="edit-links" href="createnews.php">
                                                <p>Create News</p>
                                            </a>
                                            <a class="edit-links" href="createmods.php">
                                                <p>Create Mods</p>
                                            </a>
                                            <a class="edit-links" href="createcodes.php">
                                                <p>Create Codes</p>
                                            </a>
                                            <a class="edit-links" href="createtrainers.php">
                                                <p>Create Trainers</p>
                                            </a>
                                            <a class="edit-links" href="createwalkthroughs.php">
                                                <p>Create Walkthroughs</p>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                    ...
                                    <div class="col-md-4">
                                        <div class="well well-sm">
                                            <div class="title-contact-form" style="text-align: center;">
                                                <p>Show/Edit/Delete Section</p>

                                            </div>
                                            <a class="edit-links" href="editprofiles.php">
                                                <p>Show/Edit/Delete Users</p>
                                            </a>
                                            <a class="edit-links" href="editnews.php">
                                                <p>Show/Edit/Delete News</p>
                                            </a>
                                            <a class="edit-links" href="editmods.php">
                                                <p>Show/Edit/Delete Mods</p>
                                            </a>
                                            <a class="edit-links" href="editcodes.php">
                                                <p>Show/Edit/Delete Codes</p>
                                            </a>
                                            <a class="edit-links" href="edittrainers.php">
                                                <p>Show/Edit/Delete Trainers</p>
                                            </a>
                                            <a class="edit-links" href="editwalkthroughs.php">
                                                <p>Show/Edit/Delete Walkthroughs</p>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-md-1">
