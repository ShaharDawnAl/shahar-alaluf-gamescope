                                        ...
                                        <form class="form-horizontal" action="register.php" method="post" enctype="multipart/form-data">
                                            <fieldset>
                                                ...
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <input id="useusernamerid" name="username" class="form-control input-large" type="text" placeholder="Username" required="">
                                ...
                                <div class="row" id="message-us">
                                    ...
                                    <div class="col-md-12">
                                        <div class="well well-sm table-responsive">
                                            <?php
									$db = new dbClass();
									$trainersArr = $db->getTrainers();
									
									echo "<table class='table' style='widh:100%'>
									<tr>
									<th>ID</th>
									<th>Title</th>
									<th>Description</th>
