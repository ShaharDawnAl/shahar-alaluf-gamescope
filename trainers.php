...
?>
    ...
    <body>
                    ...
                    <ul class="nav navbar-nav navbar-right" id="navbar-middle">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li>
                                    <a href="trainers.php" class="cheats-active">Trainers</a>
                                </li>
                                <li>
        ...
        ?>
                ...
                <?php
            // Get the trainers for front page ordered by date!
            $db = new dbClass();
            $trainersbydate = $db->getTrainersFrontDateOrdered();
            if (count((array)$trainersbydate)<3)
            {
                $trainersbydate[0] = new Trainers();
                $trainersbydate[0]->setTrainersId(0);
                $trainersbydate[1] = new Trainers();
                $trainersbydate[1]->setTrainersId(0);
                $trainersbydate[2] = new Trainers();
                $trainersbydate[2]->setTrainersId(0);
            }
        ...
        ?>
                    ...
                    <header id="myCarousel" class="carousel slide">
                        ...
                        ?>
                                    <div id="carouselStyle" class="fill" style="background-image:url('<?php echo $t1->getTrainersCarPic(); ?>');"></div>
                                    <div class="carousel-caption">
                                        <h2>
                                            <?php
                                    // echo the title with checks
                                    if (strlen($t1->getTrainersTitle())>40)
                                        echo substr($t1->getTrainersTitle(), 0, 40)."...";
                                    else
                                    {
                            ...
                            <?php
				        $trainersid = $trainersbydate[1]->getTrainersId();
				        $t1 = $db->getTrainersByTrainersId($trainersid);
                    ?>
                                <div class="item">
                                ...
                                <?php
                        $trainersid = $trainersbydate[2]->getTrainersId();
                        $t1 = $db->getTrainersByTrainersId($trainersid);
				    ?>
                                    <div class="item">
                                        <div class="fill" style="background-image:url('<?php echo $t1->getTrainersCarPic(); ?>');"></div>
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <nav class="navbar navbar-default" role="navigation" id="home-search">
                                ...
                                <span class="icon-bar"></span>
                                    ...
                                    <div class="navbar-brand" style="color: white; font-size: 30px;">Trainers</div>
                                </div>
                                <!-- Collect the nav links, forms, and other content for toggling -->
                        ...
                        <div class="row">
                            <div class="col-md-12" style="">
                                <div class="demo demo4_top">
                                    ...
                                    $statement = "trainers order by trainers_date DESC";
                                    echo pagination("trainers", $statement,$limit,$page);
                                ?>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="more-news">
                            <?php 
                        $db = new dbClass();
                        $trainersArray=$db->getTrainersOrdered($startpoint, $limit);
                                ...
                                <div class="row" style="padding:1%; word-wrap: break-word;">
                                    <div class="col-md-3">
                                        <a href="trainerscontent.php?trainerspage='.$trainersArray[$i]->getTrainersId().'">
                                            <img class="news-images" src="'.$trainersArray[$i]->getTrainersBoxPic().'" alt="">
                                        </a>
                                    </div>
