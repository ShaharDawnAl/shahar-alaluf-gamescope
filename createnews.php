                                        ...
                                        <div class="well well-sm">
                                            <form class="form-horizontal" action="addnews.php" method="post" enctype="multipart/form-data">
                                                <fieldset>
                                                    ...
                                                    <!-- Text input-->
                                                    <div class="control-group">
                                                        <label class="control-label" for="newsuser">News By:</label>
                                                        <div class="controls">
                                                            <input id="newsuser" name="newsuser" value="<?php echo $_SESSION['username']; ?>" class="form-control input-large" type="text" placeholder="" required="required" readonly>
                                                        </div>
                                                    </div>
                                                    <div class="control-group">
                                                        <label class="control-label" for="newsTitle">News Title:</label>
                                                        <div class="controls">
                                                            <input id="newsTitle" name="newsTitle" class="form-control input-large" type="text" placeholder="" required="required">
                                                        </div>
                                                    </div>
                                                    <div class="control-group">
                                                        <label class="control-label" for="newsDescription">News Description:</label>
                                                        <div class="controls">
                                                            <textarea name="newsDescription" id="message" class="form-control" rows="9" cols="25" required="required" placeholder=""></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="control-group">
                                                        <label class="control-label" for="newsVideo">Additional Video link:</label>
                                                        <div class="controls">
                                                            <input id="newsVideo" name="newsVideo" class="form-control" type="text" placeholder="" class="input-large">
                                                            <em>Not required, will be presented on front content page</em>
                                                        </div>
                                                    </div>
                                                    <div class="full-width" id="upload">
                                                        <input type="file" name="news_carousel_picture" id="base-input" class="form-control form-input form-style-base" accept="image/*" required="required">
                                                        <input type="text" id="fake-input" class="form-control form-input form-style-fake" placeholder="Upload News Carousel Picture (Best 1200x700)" readonly>
                                                        <span class="glyphicon glyphicon-open input-place"></span>
                                                    </div>
                                                    <div class="full-width" id="upload">
                                                        <input type="file" name="news_box_picture" id="base-input1" class="form-control form-input form-style-base" accept="image/*" required="required">
                                                    ...
                                                    <div class="col-sm-12" style="display:inline-block;">
                                                        <div class="control-group">
                                                            <label class="control-label" for="confirmsignup"></label>
                                                            <div class="controls">
                                                                <button name="confirmnewscreate" class="btn btn-success" type="submit">Create News</button>
