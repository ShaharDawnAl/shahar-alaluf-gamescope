                                ...
                                <div class="row" id="message-us">
                                    ...
                                    <div class="col-md-12 ">
                                        <div class="well table-responsive">
                                            <?php
									$db = new dbClass();
									$usersArr = $db->getUsers();
							
									echo "<table class='table table-responsive' style='100%'>
									<tr>
									<th>ID</th>
									<th>Email</th>
									<th>Password</th>
									...
									for ($i=0;$i<count((array)$usersArr);$i++)
									{   
										if ($usersArr[$i]->getUserAdmin() == 1)
											$isadmin = "Admin";
										else
											$isadmin = "Not Admin";
										echo "<tr>
										<td>".$usersArr[$i]->getUserId()."</td>
										<td>".$usersArr[$i]->getUserEmail()."</td>
										<td>".substr($usersArr[$i]->getUserPassword(), 0, 5)."...</td>
										<td>".$usersArr[$i]->getUserName()."</td>
										<td>".$usersArr[$i]->getUserFName()."</td>
										<td>".$usersArr[$i]->getUserLName()."</td>
										<td>".$isadmin."</td>
										<td><a href='editprofile_admin.php?Edit=".$usersArr[$i]->getUserId()."'><i class='fa fa-pencil-square-o' aria-hidden='true'></i></a></td>
										<td><a href='deleteprofile.php?Delete=".$usersArr[$i]->getUserId()."'><i class='fa fa-trash' aria-hidden='true'></a></i></td>
										</tr>";
									}
									echo "</table>";
									$db = null;
