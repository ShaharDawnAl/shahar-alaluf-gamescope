...
?>
    ...
    <body>
        ...
        ?>
                    ...
                    <div class="row" id="details">
                        <div class="col-md-12">
                            <div class="adminman">
                                <div class="row" id="message-us">
                                    <div class="title-contact-form">
                                        <p>Create Trainers Form</p>
                                    </div>
                                    <div class="col-md-2">
                                    </div>
                                    <div class="col-md-8">
                                        <div class="well well-sm">
                                            <form class="form-horizontal" action="addtrainers.php" method="post" enctype="multipart/form-data">
                                                <fieldset>
                                                    <!-- Create Trainers Form -->
                                                    <!-- Text input-->
                                                    <div class="control-group">
                                                        <label class="control-label" for="trainersuser">Trainer Uploaded By:</label>
                                                        <div class="controls">
                                                            <input id="trainersuser" name="trainersuser" value="<?php echo $_SESSION['username']; ?>" class="form-control input-large" type="text" placeholder="" required="required" readonly>
                                                        </div>
                                                    </div>
                                                    <div class="control-group">
                                                        <label class="control-label" for="trainersTitle">Trainer Title:</label>
                                                        <div class="controls">
                                                            <input id="trainersTitle" name="trainersTitle" class="form-control input-large" type="text" placeholder="" pattern=".{5,}" required="required">
                                                        </div>
                                                    ...
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls">
                                                            <textarea name="trainersDescription" id="message" class="form-control" rows="9" cols="25" minlength="30" required="required" placeholder=""></textarea>
                                                        </div>
                                                    ...
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls">
                                                            <input id="trainersVideo" name="trainersVideo" class="form-control input-large" type="text" placeholder="">
                                                            <em>Not required, will be presented on front content page</em>
                                                        </div>
                                                    </div>
                                                    <br>
                                                    <div class="control-group">
                                                        <input type="checkbox" name="trainersActive" value="active" checked> Activate (Will be showen on the list)<br>
                                                    </div>
                                                    <div class="full-width" id="upload">
                                                        <input type="file" name="trainers_download" id="download-input" class="form-control form-input form-style-base" required="required">
                                                        ...
                                                        <em>Download file, not over 1.5 MB! (XAMPP LIMITED)</em>
                                                    </div>
                                                    <div class="full-width" id="upload">
                                                        <input type="file" name="trainers_carousel_picture" id="base-input" class="form-control form-input form-style-base" accept="image/*" required="required">
                                                    ...
                                                    <div class="full-width" id="upload">
                                                        <input type="file" name="trainers_box_picture" id="base-input1" class="form-control form-input form-style-base" accept="image/*" required="required">
                                                    ...
                                                    <div class="col-sm-12" style="display:inline-block;">
                                                        <div class="control-group">
                                                            <label class="control-label" for="confirmsignup"></label>
                                                            <div class="controls">
                                                                <button name="confirmtrainerscreate" class="btn btn-success" type="submit">Create Trainer</button>
                                                                <input type="button" class="middle-button" value="Back To Admin Management" onclick="history.back(-1)" />
                                                            </div>
                                                        </div>
                                                    </div>
                ...
                <!-- Javascript code for handling file uploads size and fakepath text  -->
                <script>
