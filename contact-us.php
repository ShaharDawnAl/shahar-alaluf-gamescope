            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-right" id="navbar-middle">
                        ...
                        <li>
                            <a href="contact-us.php" id="nav-active">Contact Us</a>
                        </li>
        ...
        ?>
                ...
                <div class="container">
                    ...
                    <div class="row" id="details">
                        <div class="col-md-12">
                            <div class="contact">
                                <p>GameScope was founded in 2017 as the first hardcore gamer focused site covering content primarily related to the PC hardcore gaming community. The term "hardcore gamer" did not exist in 1998, we invented it. Since then, with the help of the community, the site has grown to become the largest archive of user generated content specific to hardcore gamers, in addition a go-to source for news and official gaming content for PC &amp; Console games. Who is a hardcore gamer? Hardcore gamers are technology enthusiasts that play a wide range of games. They are early adopters of technology and are the trend-setters of the video gaming industry. Many of whom end up being video game developers themselves.</p>

                                <div class="col-lg-12">
                                    <h6 class="description">The Co-founders</h6>
                                    <div class="row pt-md">
                                        <div class="col-md-3 col-sm-4 col-xs-12 profile">
                                            <div class="img-box">
                                                <img src="images/shahar.jpg" class="img-responsive">
                                            </div>
                                            <h1>Shahar Alaluf</h1>
                                            <h2>Co-founder</h2>
                                            <ul class="aboutus">
                                                <li>
                                                    Email: shahar.al2013@gmail.com
                                                </li>
                                                <li>
                                                    Software Engineer Graduated at: Technion University
                                                </li>
                                            </ul>
                                        </div>
                                        <div class="col-md-3 col-sm-4 col-xs-12 profile">
                                            <div class="img-box">
                                                <img src="images/aviad.jpg" class="img-responsive">
                                            </div>
                                            <h1>Aviad Kattav</h1>
                                            <h2>Co-founder</h2>
                                            <ul class="aboutus">
                                                <li>
                                                    Email: aviadkatav@gmail.com
                                                </li>
                                                <li>
                                                    Software Engineer Graduated at: Technion University
                                                </li>
                                ...
                                <div class="row" id="message-us">
                                    ...
                                    <div class="col-md-8">
                                        <div class="well well-sm">
                                            <form action="contact-us_process.php" method="post">
                                                <div class="row" id="send-message">
                                                    ...
                                                    Full Name
                                                            ...
                                                            <input type="text" class="form-control" name="userFullName" id="name" placeholder="Enter name" required="required" />
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="email">
                                                    Email Address
                                                            ...
                                                            <div class="input-group" style="width: 100%;">
                                                                ...
                                                                <input type="email" class="form-control" name="userEmail" id="email" placeholder="Enter email" required="required" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                    ...
                                                    Message
                                                            ...
                                                            <textarea name="userMessage" id="message" class="form-control" rows="9" cols="25" required="required" placeholder="Message"></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                    ...
                                    <div class="col-md-4">
                                        <form>
                                            <legend id=legend-office><span class="glyphicon glyphicon-globe"></span> Our office</legend>
                                            <address>
                <strong>GameScope, Inc.</strong><br>
                Haifa, hatotahim 3200003<br>
                Israel, Haifa <br>
                <abbr title="Phone">
                    P:</abbr>
                077-887-5555
