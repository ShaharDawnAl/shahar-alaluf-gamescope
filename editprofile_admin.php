<?php
	...
	//check if there is nothing in the session
		...
		if (isset($_GET['Edit']))
		{
			...
			$u1 = new Users();
			$u1->setUserId($userid);
			$u1 = $db->getUserById($u1->getUserId());
		}
		else
			header("Location: index.php");
?>
                                ...
                                <div class="row" id="message-us">
                                    ...
                                    <div class="col-md-8">
                                        <div class="well well-sm">
                                            <form class="form-horizontal" action="editprofile_process_admin.php" method="post" enctype="multipart/form-data">
                                                <fieldset>
                                                    <!-- Create News Form -->
                                                    <!-- Avatar input-->
                                                    <div class="control-group">
                                                        <label class="control-label" for="reenterpassword">Change Avatar: </label><em>(Optional)</em>
                                                        <?php echo '<img src="'.$u1->getUserAvatar().'" alt="Alternate Text" class="img-responsive" width="100px">'; ?>
                                                        <?php $_SESSION['oldAvatar'] = $u1->getUserAvatar(); ?>
                                                        <div class="controls">
                                                            <input id="avatar" class="form-control input-large" name="chgAvatar" type="file">
                                                        </div>
                                                    </div>
                                                    <!-- Text input-->
                                                    <div class="control-group">
                                                        <label class="control-label" for="chgFName">Change First Name:</label>
                                                        <div class="controls">
                                                            <input id="chgFName" name="chgFName" class="form-control input-large" type="text" placeholder="" value="<?php echo $u1->getUserFName(); ?>" required="required">
                                                        </div>
                                                    </div>
                                                    <div class="control-group">
                                                        <label class="control-label" for="chgLName">Change Last Name:</label>
                                                        <div class="controls">
                                                            <input id="chgLName" name="chgLName" class="form-control input-large" type="text" placeholder="" value="<?php echo $u1->getUserLName(); ?>" required="required">
                                                        </div>
                                                    </div>
                                                    <div class="control-group">
                                                        <label class="control-label" for="chgEmail">Change Email:</label>
                                                        <div class="controls">
                                                            <input id="chgEmail" name="chgEmail" class="form-control input-large" type="text" placeholder="" value="<?php echo $u1->getUserEmail(); ?>" required="required">
                                                        </div>
                                                    </div>
                                                    <div class="control-group">
                                                        <label class="control-label" for="chgUName">Change Username:</label>
                                                        <div class="controls">
                                                            <input id="chgUName" name="chgUName" class="form-control input-large" type="text" placeholder="" value="<?php echo $u1->getUserName(); ?>" required="required">
                                                            <?php $_SESSION['oldUName'] = $u1->getUserName(); ?>
                                                        </div>
                                                    </div>
                                                    <div class="control-group">
                                                        <label class="control-label" for="chgPasswd">Change Password: </label><em>(Optional)</em>
                                                        <div class="controls">
                                                            <input id="chgPasswd" type="password" name="chgPasswd" class="form-control input-large" type="text" placeholder="">
                                                        </div>
                                                    </div>
                                                    <div class="control-group">
                                                        <label class="control-label" for="chgRePasswd">Re-Enter Password: </label><em>(Optional)</em>
                                                        <div class="controls">
                                                            <input id="chgRePasswd" type="password" name="chgRePasswd" class="form-control input-large" type="text" placeholder="">
                                                        </div>
                                                    </div>
                                                    <em>Note: If you choose to change password, both password fields must be entered.</em>
                                                    <div class="control-group">
                                                        <div class="controls">
                                                            <?php
											if ($u1->getUserAdmin())
												echo '<input type="checkbox" name="chgAdmin" type="text" class="input-large" checked> Administrator';
											else
												echo '<input type="checkbox" name="chgAdmin" type="text" class="input-large"> Administrator';
										?>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-2">
                                                        <div class="control-group">
                                                            <label class="control-label" for="confirmprofileeditadmin"></label>
                                                            <div class="controls">
                                                                <button name="confirmprofileeditadmin" class="btn btn-success" type="submit">Edit Profile</button>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-5"></div>
                                                    </div>
