...
?>
    ...
    <body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-right" id="navbar-middle">
                        ...
                        <li>
                            <a href="mods.php" id="nav-active">Mods</a>
                        </li>
                        <li class="dropdown">
        ...
        ?>
                ...
                <?php
            // Get the mods for front page ordered by date!
            $db = new dbClass();
            $modsbydate = $db->getModsFrontDateOrdered();
            if (count((array)$modsbydate)<3)
            {
                $modsbydate[0] = new Mods();
                $modsbydate[0]->setModsId(0);
                $modsbydate[1] = new Mods();
                $modsbydate[1]->setModsId(0);
                $modsbydate[2] = new Mods();
                $modsbydate[2]->setModsId(0);
            }
            $countmods = count((array)$modsbydate);
        ?>
                    <!-- Header Carousel -->
                    <header id="myCarousel" class="carousel slide">
                        ...
                        ?>
                                    <div id="carouselStyle" class="fill" style="background-image:url('<?php echo $m1->getModsCarPic(); ?>');"></div>
                                    <div class="carousel-caption">
                                        <h2>
                                            <?php
                                    // echo the title with checks
                                    if (strlen($m1->getModsTitle())>40)
                                        echo substr($m1->getModsTitle(), 0, 40)."...";
                                    else
                                    {
                            ...
                            <?php
				        $modsid = $modsbydate[1]->getModsId();
				        $m1 = $db->getModsByModsId($modsid);
                    ?>
                                <div class="item">
                                    <div class="fill" style="background-image:url('<?php echo $m1->getModsCarPic(); ?>');"></div>
                                    <div class="carousel-caption">
                                        <h2>
                                            <?php
                                        // echo the title with checks
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <nav class="navbar navbar-default" role="navigation" id="home-search">
                                ...
                                <span class="icon-bar"></span>
                                    ...
                                    <div class="navbar-brand" style="color: white; font-size: 30px;">Mods</div>
                                </div>
                                <!-- Collect the nav links, forms, and other content for toggling -->
                        ...
                        <div class="row">
                            <div class="col-md-12" style="">
                                <div class="demo demo4_top">
                                    ...
                                    $statement = "mods order by mods_date DESC";
                                    echo pagination("mods", $statement,$limit,$page);
                                ?>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="more-news">
                            <?php 
                        $db = new dbClass();
                        $modsArray=$db->getModsOrdered($startpoint, $limit);
                                ...
                                <div class="row" style="padding:1%; word-wrap: break-word;">
                                    <div class="col-md-3">
                                        <a href="modscontent.php?modspage='.$modsArray[$i]->getModsId().'">
                                            <img class="news-images" src="'.$modsArray[$i]->getModsBoxPic().'" alt="">
                                        </a>
                                    </div>
                                    
                                    <div class="col-md-9">
                                        <p>'.substr($modsArray[$i]->getModsDesc(), 0, 200)."...".'</p>
                                        <p>Mods by: '.$db->getUsernameById($modsArray[$i]->getModsUserId()).'</p>
