                    ...
                    <div class="row" id="details">
                        <div class="col-md-12">
                            <div class="adminman">
                                <div class="row" id="message-us">
                                    <div class="title-contact-form">
                                        <p>Create Mods Form</p>
                                    </div>
                                    <div class="col-md-2">
                                    </div>
                                    <div class="col-md-8">
                                        <div class="well well-sm">
                                            <form class="form-horizontal" action="addmods.php" method="post" enctype="multipart/form-data">
                                                <fieldset>
                                                    <!-- Create Mod Form -->
                                                    <!-- Text input-->
                                                    <div class="control-group">
                                                        <label class="control-label" for="moduser">Mod Uploaded By:</label>
                                                        <div class="controls">
                                                            <input id="moduser" name="moduser" value="<?php echo $_SESSION['username']; ?>" class="form-control input-large" type="text" placeholder="" required="required" readonly>
                                                        </div>
                                                    </div>
                                                    <div class="control-group">
                                                        <label class="control-label" for="modTitle">Mod Title:</label>
                                                        <div class="controls">
                                                            <input id="modTitle" name="modTitle" class="form-control input-large" type="text" placeholder="" pattern=".{5,}" required="required">
                                                        </div>
                                                        <em>Minimum 5 letters</em>
                                                    </div>
                                                    <div class="control-group">
                                                        <label class="control-label" for="modDescription">Mod Description:</label>
                                                        <div class="controls">
                                                            <textarea name="modDescription" id="message" class="form-control" rows="9" cols="25" minlength="30" required="required" placeholder=""></textarea>
                                                        </div>
                                                        <em>Minimum 30 letters</em>
                                                    </div>
                                                    <div class="control-group">
                                                        <label class="control-label" for="modVideo">Additional Video link:</label>
                                                        <div class="controls">
                                                            <input id="modVideo" name="modVideo" class="form-control input-large" type="text" placeholder="">
                                                            <em>Not required, will be presented on front content page</em>
                                                        </div>
                                                    </div>
                                                    <br>
                                                    <div class="control-group">
                                                        <input type="checkbox" name="modActive" value="active" checked> Activate (Will be showen on the list)<br>
                                                    </div>
                                                    <div class="full-width" id="upload">
                                                        <input type="file" name="mod_download" id="download-input" class="form-control form-input form-style-base" required="required">
                                                    ...
                                                    <div class="full-width" id="upload">
                                                        <input type="file" name="mod_carousel_picture" id="base-input" class="form-control form-input form-style-base" accept="image/*" required="required">
                                                        <input type="text" id="fake-input1" class="form-control form-input form-style-fake" placeholder="Upload Mod Carousel Picture (Best 1200x700)" readonly>
                                                        <span class="glyphicon glyphicon-open input-place"></span>
                                                    </div>
                                                    <div class="full-width" id="upload">
                                                        <input type="file" name="mod_box_picture" id="base-input1" class="form-control form-input form-style-base" accept="image/*" required="required">
                                                        <input type="text" id="fake-input2" class="form-control form-input form-style-fake" placeholder="Upload Mod Box Picture" readonly>
                                                        <span class="glyphicon glyphicon-open input-place"></span>
                                                    </div>
                                                    <br>
                                                    <h1 style="text-align: center">Additional Pictures</h1>
                                                    <div class="full-width" id="upload">
                                                        <input type="file" name="mod_pictures[]" id="addpic-multiple" class="form-control form-input form-style-base" accept="image/*" multiple>
                                                    ...
                                                    <div class="col-sm-12" style="display:inline-block;">
                                                        <div class="control-group">
                                                            <label class="control-label" for="confirmsignup"></label>
                                                            <div class="controls">
                                                                <button name="confirmmodcreate" class="btn btn-success" type="submit">Create Mod</button>
