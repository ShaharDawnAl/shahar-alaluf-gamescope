                                ...
                                <div class="row" id="message-us">
                                    ...
                                    <div class="col-md-8">
                                        <div class="well well-sm">
                                            <form class="form-horizontal" action="editprofile_process.php" method="post" enctype="multipart/form-data">
                                                <fieldset>
                                                    <!-- Create News Form -->
                                                    <!-- Avatar input-->
                                                    <div class="control-group">
                                                        <label class="control-label" name="oldAvatar" for="reenterpassword">Change Avatar: </label><em>(Optional)</em>
                                                    ...
                                                    <div class="col-md-2">
                                                        <div class="control-group">
                                                            <label class="control-label" for="confirmsignup"></label>
                                                            <div class="controls">
                                                                <button name="confirmprofileedit" class="btn btn-success" type="submit">Edit Profile</button>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-5"></div>
                                                    </div>
