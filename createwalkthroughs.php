                    ...
                    <div class="row" id="details">
                        <div class="col-md-12">
                            <div class="adminman">
                                <div class="row" id="message-us">
                                    <div class="title-contact-form">
                                        <p>Create Walkthroughs Form</p>
                                    </div>
                                    <div class="col-md-2">
                                    </div>
                                    <div class="col-md-8">
                                        <div class="well well-sm">
                                            <form class="form-horizontal" action="addwalkthroughs.php" method="post" enctype="multipart/form-data">
                                                <fieldset>
                                                    <!-- Create Walkthroughs Form -->
                                                    <!-- Text input-->
                                                    <div class="control-group">
                                                        <label class="control-label" for="walkthroughsuser">Walkthrough Uploaded By:</label>
                                                        <div class="controls">
                                                            <input id="walkthroughsuser" name="walkthroughsuser" value="<?php echo $_SESSION['username']; ?>" class="form-control input-large" type="text" placeholder="" required="required" readonly>
                                                        </div>
                                                    </div>
                                                    <div class="control-group">
                                                        <label class="control-label" for="walkthroughsTitle">Walkthrough Title:</label>
                                                        <div class="controls">
                                                            <input id="walkthroughsTitle" name="walkthroughsTitle" class="form-control input-large" type="text" placeholder="" pattern=".{5,}" required="required">
                                                        </div>
                                                        <em>Minimum 5 letters</em>
                                                    </div>
                                                    <div class="control-group">
                                                        <label class="control-label" for="walkthroughsDescription">Walkthroughs Description:</label>
                                                        <div class="controls">
                                                            <textarea name="walkthroughsDescription" id="message" class="form-control" rows="9" cols="25" minlength="30" required="required" placeholder=""></textarea>
                                                        </div>
                                                    ...
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls">
                                                            <input id="walkthroughsVideo" name="walkthroughsVideo" class="form-control input-large" type="text" placeholder="">
                                                            <em>Not required, will be presented on front content page</em>
                                                        </div>
                                                    </div>
                                                    <br>
                                                    <div class="control-group">
                                                        <input type="checkbox" name="walkthroughsActive" value="active" checked> Activate (Will be showen on the list)<br>
                                                    </div>
                                                    <div class="full-width" id="upload">
                                                        <input type="file" name="walkthroughs_carousel_picture" id="base-input" class="form-control form-input form-style-base" accept="image/*" required="required">
                                                    ...
                                                    <div class="full-width" id="upload">
                                                        <input type="file" name="walkthroughs_box_picture" id="base-input1" class="form-control form-input form-style-base" accept="image/*" required="required">
                                                    ...
                                                    <div class="col-sm-12" style="display:inline-block;">
                                                        <div class="control-group">
                                                            <label class="control-label" for="confirmsignup"></label>
                                                            <div class="controls">
                                                                <button name="confirmwalkthroughscreate" class="btn btn-success" type="submit">Create Walkthroughs</button>
